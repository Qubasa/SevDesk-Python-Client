...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/Invoice/{invoiceId}/render".format(client.base_url, invoiceId=invoice_id)
    ...
    *,
    ...
    """Render the pdf document of an invoice
     ...
     Using this endpoint you can render the pdf document of an invoice.<br>
         Use cases for this are the retrieval of the pdf location or the forceful re-render of a already
    sent invoice.<br>
