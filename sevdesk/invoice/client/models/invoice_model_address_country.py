...
T = TypeVar("T", bound="InvoiceModelAddressCountry")


@attr.s(auto_attribs=True)
class InvoiceModelAddressCountry:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        invoice_model_address_country = cls(
            id=id,
            object_name=object_name,
        )

        invoice_model_address_country.additional_properties = d
        return invoice_model_address_country
