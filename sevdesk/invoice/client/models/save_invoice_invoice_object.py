...
from ..models.invoice_model_address_contact_ref import InvoiceModelAddressContactRef
from ..models.invoice_model_address_country import InvoiceModelAddressCountry
from ..models.invoice_model_contact import InvoiceModelContact
from ..models.invoice_model_contact_person import InvoiceModelContactPerson
from ..models.invoice_model_cost_centre import InvoiceModelCostCentre
from ..models.invoice_model_create_user import InvoiceModelCreateUser
from ..models.invoice_model_datev_connect_online import InvoiceModelDatevConnectOnline
from ..models.invoice_model_entry_type import InvoiceModelEntryType
from ..models.invoice_model_invoice_type import InvoiceModelInvoiceType
from ..models.invoice_model_origin import InvoiceModelOrigin
from ..models.invoice_model_payment_method import InvoiceModelPaymentMethod
from ..models.invoice_model_send_type import InvoiceModelSendType
from ..models.invoice_model_sev_client import InvoiceModelSevClient
from ..models.invoice_model_status import InvoiceModelStatus
from ..models.invoice_model_tax_set import InvoiceModelTaxSet
from ..models.invoice_model_tax_type import InvoiceModelTaxType
from ..types import UNSET, Unset

T = TypeVar("T", bound="SaveInvoiceInvoiceObject")


@attr.s(auto_attribs=True)
class SaveInvoiceInvoiceObject:
    """
    Attributes:
        ...
        status (InvoiceModelStatus): Please have a look in our
        ...
        small_settlement (bool): Defines if the client uses the small settlement scheme.
                If yes, the invoice must not contain any vat
        contact_person (InvoiceModelContactPerson): The user who acts as a contact person for the invoice
        tax_rate (float): Is overwritten by invoice position tax rates Example: 19.
        tax_text (str): A common tax text would be 'Umsatzsteuer 19%' Example: Umsatzsteuer 19%.
        tax_type (InvoiceModelTaxType): Tax type of the invoice.
            ...
            Tax rates are heavily connected to the tax type used. Default: InvoiceModelTaxType.DEFAULT.
        invoice_type (InvoiceModelInvoiceType): Type of the invoice. For more information on the different types, check
        ...
        update (Union[Unset, datetime.datetime]): Date of last invoice update
        sev_client (Union[Unset, InvoiceModelSevClient]): Client to which invoice belongs. Will be filled automatically
        header (Union[Unset, None, str]): Normally consist of prefix plus the invoice number
        ...
        time_to_pay (Union[Unset, None, int]): The time the customer has to pay the invoice in days
        discount_time (Union[Unset, None, int]): If a value other than zero is used for the discount attribute,
        ...
        address_country (Union[Unset, None, InvoiceModelAddressCountry]): Can be omitted as complete address is defined
            in address attribute
        pay_date (Union[Unset, None, datetime.datetime]): Needs to be timestamp or dd.mm.yyyy
        create_user (Union[Unset, InvoiceModelCreateUser]): Will be filled automatically by our system and can't be
            changed
        dunning_level (Union[Unset, None, int]): Defines how many reminders have already been sent for the invoice.
        ...
        address_contact_ref (Union[Unset, None, InvoiceModelAddressContactRef]): Address contact reference.
        payment_method (Union[Unset, InvoiceModelPaymentMethod]): Payment method used for the invoice
        cost_centre (Union[Unset, InvoiceModelCostCentre]): Cost centre for the invoice
        send_date (Union[Unset, None, datetime.datetime]): The date the invoice was sent to the customer
        origin (Union[Unset, None, InvoiceModelOrigin]): Origin of the invoice. Could f.e. be an order
        ...
        tax_set (Union[Unset, None, InvoiceModelTaxSet]): Tax set of the invoice. Needs to be added if you chose the tax
            type custom
        ...
        sum_net (Union[Unset, float]): Net sum of the invoice
        sum_tax (Union[Unset, float]): Tax sum of the invoice
        sum_gross (Union[Unset, float]): Gross sum of the invoice
        sum_discounts (Union[Unset, float]): Sum of all discounts in the invoice
        sum_net_foreign_currency (Union[Unset, float]): Net sum of the invoice in the foreign currency
        sum_tax_foreign_currency (Union[Unset, float]): Tax sum of the invoice in the foreign currency
        sum_gross_foreign_currency (Union[Unset, float]): Gross sum of the invoice in the foreign currency
        sum_discounts_foreign_currency (Union[Unset, float]): Discounts sum of the invoice in the foreign currency
        sum_net_accounting (Union[Unset, float]): Net accounting sum of the invoice. Is usually the same as sumNet
        sum_tax_accounting (Union[Unset, float]): Tax accounting sum of the invoice. Is usually the same as sumTax
        sum_gross_accounting (Union[Unset, float]): Gross accounting sum of the invoice. Is usually the same as sumGross
        paid_amount (Union[Unset, None, float]): Amount which has already been paid for this invoice by the customer
        entry_type (Union[Unset, None, InvoiceModelEntryType]): Deprecated attribute.
        ...
        show_net (Union[Unset, bool]): If true, the net amount of each position will be shown on the invoice. Otherwise
            gross amount Default: True.
        enshrined (Union[Unset, None, datetime.datetime]): Defines if and when invoice was enshrined. Enshrined invoices
            can not be manipulated.
        send_type (Union[Unset, None, InvoiceModelSendType]): Type which was used to send the invoice. IMPORTANT: Please
        ...
        datev_connect_online (Union[Unset, None, InvoiceModelDatevConnectOnline]): Internal attribute
    ...
    contact_person: InvoiceModelContactPerson
    tax_rate: float
    tax_text: str
    discount: int = 0
    ...
    sev_client: Union[Unset, InvoiceModelSevClient] = UNSET
    ...
    address_country: Union[Unset, None, InvoiceModelAddressCountry] = UNSET
    pay_date: Union[Unset, None, datetime.datetime] = UNSET
    create_user: Union[Unset, InvoiceModelCreateUser] = UNSET
    dunning_level: Union[Unset, None, int] = UNSET
    address_parent_name: Union[Unset, None, str] = UNSET
    address_contact_ref: Union[Unset, None, InvoiceModelAddressContactRef] = UNSET
    payment_method: Union[Unset, InvoiceModelPaymentMethod] = UNSET
    cost_centre: Union[Unset, InvoiceModelCostCentre] = UNSET
    send_date: Union[Unset, None, datetime.datetime] = UNSET
    origin: Union[Unset, None, InvoiceModelOrigin] = UNSET
    ...
    tax_set: Union[Unset, None, InvoiceModelTaxSet] = UNSET
    ...
    entry_type: Union[Unset, None, InvoiceModelEntryType] = UNSET
    ...
    send_type: Union[Unset, None, InvoiceModelSendType] = UNSET
    delivery_date_until: Union[Unset, None, int] = UNSET
    datev_connect_online: Union[Unset, None, InvoiceModelDatevConnectOnline] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        address_country: Union[Unset, None, Dict[str, Any]] = UNSET
        if not isinstance(self.address_country, Unset):
            address_country = (
                self.address_country.to_dict() if self.address_country else None
            )
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        status = InvoiceModelStatus(d.pop("status"))

        small_settlement = d.pop("smallSettlement")

        contact_person = InvoiceModelContactPerson.from_dict(d.pop("contactPerson"))

        tax_rate = d.pop("taxRate")

        tax_text = d.pop("taxText")

        tax_type = InvoiceModelTaxType(d.pop("taxType"))

        invoice_type = InvoiceModelInvoiceType(d.pop("invoiceType"))
        ...
        sev_client: Union[Unset, InvoiceModelSevClient]
        if isinstance(_sev_client, Unset):
            sev_client = UNSET
        else:
            sev_client = InvoiceModelSevClient.from_dict(_sev_client)
        ...
        address_country: Union[Unset, None, InvoiceModelAddressCountry]
        if _address_country is None:
            address_country = None
        elif isinstance(_address_country, Unset):
            address_country = UNSET
        else:
            address_country = InvoiceModelAddressCountry.from_dict(_address_country)
        ...
        create_user: Union[Unset, InvoiceModelCreateUser]
        if isinstance(_create_user, Unset):
            create_user = UNSET
        else:
            create_user = InvoiceModelCreateUser.from_dict(_create_user)
        ...
        address_contact_ref: Union[Unset, None, InvoiceModelAddressContactRef]
        if _address_contact_ref is None:
            ...
            address_contact_ref = InvoiceModelAddressContactRef.from_dict(
                _address_contact_ref
            )

        _payment_method = d.pop("paymentMethod", UNSET)
        payment_method: Union[Unset, InvoiceModelPaymentMethod]
        if isinstance(_payment_method, Unset):
            payment_method = UNSET
        else:
            payment_method = InvoiceModelPaymentMethod.from_dict(_payment_method)

        _cost_centre = d.pop("costCentre", UNSET)
        cost_centre: Union[Unset, InvoiceModelCostCentre]
        if isinstance(_cost_centre, Unset):
            cost_centre = UNSET
        else:
            cost_centre = InvoiceModelCostCentre.from_dict(_cost_centre)
        ...
        origin: Union[Unset, None, InvoiceModelOrigin]
        if _origin is None:
            origin = None
        elif isinstance(_origin, Unset):
            origin = UNSET
        else:
            origin = InvoiceModelOrigin.from_dict(_origin)
        ...
        tax_set: Union[Unset, None, InvoiceModelTaxSet]
        if _tax_set is None:
            tax_set = None
        elif isinstance(_tax_set, Unset):
            tax_set = UNSET
        else:
            tax_set = InvoiceModelTaxSet.from_dict(_tax_set)
        ...
        entry_type: Union[Unset, None, InvoiceModelEntryType]
        if _entry_type is None:
            entry_type = None
        elif isinstance(_entry_type, Unset):
            entry_type = UNSET
        else:
            entry_type = InvoiceModelEntryType.from_dict(_entry_type)
        ...
        send_type: Union[Unset, None, InvoiceModelSendType]
        if _send_type is None:
            send_type = None
        elif isinstance(_send_type, Unset):
            send_type = UNSET
        else:
            send_type = InvoiceModelSendType(_send_type)

        delivery_date_until = d.pop("deliveryDateUntil", UNSET)

        _datev_connect_online = d.pop("datevConnectOnline", UNSET)
        datev_connect_online: Union[Unset, None, InvoiceModelDatevConnectOnline]
        if _datev_connect_online is None:
            ...
            datev_connect_online = InvoiceModelDatevConnectOnline.from_dict(
        ...
        save_invoice_invoice_object = cls(
            contact=contact,
        ...
        save_invoice_invoice_object.additional_properties = d
        return save_invoice_invoice_object
