...
T = TypeVar("T", bound="BookInvoiceJsonBodyCheckAccountTransaction")


@attr.s(auto_attribs=True)
class BookInvoiceJsonBodyCheckAccountTransaction:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        book_invoice_json_body_check_account_transaction = cls(
            id=id,
            object_name=object_name,
        )

        book_invoice_json_body_check_account_transaction.additional_properties = d
        return book_invoice_json_body_check_account_transaction
