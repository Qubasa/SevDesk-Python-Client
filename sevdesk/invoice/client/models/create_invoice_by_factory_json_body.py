...
from ..models.save_invoice_discount_save import SaveInvoiceDiscountSave
from ..models.save_invoice_invoice_object import SaveInvoiceInvoiceObject
from ..models.save_invoice_invoice_pos_delete import SaveInvoiceInvoicePosDelete
from ..models.save_invoice_invoice_pos_object import SaveInvoiceInvoicePosObject
...
class CreateInvoiceByFactoryJsonBody:
    """
    Attributes:
        invoice (SaveInvoiceInvoiceObject):
        invoice_pos_save (Optional[List[SaveInvoiceInvoicePosObject]]): The invoice positions you want to create. If you
            don't have any, set to null.
        invoice_pos_delete (Optional[List[SaveInvoiceInvoicePosDelete]]): The invoice positions you want to delete. If
            you don't have any, set to null.
        discount_save (Optional[List[SaveInvoiceDiscountSave]]): The discounts you want to create. If you don't have
            any, set to null.
        discount_delete (Optional[List[SaveInvoiceDiscountDelete]]): The discounts you want to delete. If you don't have
            any, set to null.
    ...
    invoice: SaveInvoiceInvoiceObject
    invoice_pos_save: Optional[List[SaveInvoiceInvoicePosObject]]
    invoice_pos_delete: Optional[List[SaveInvoiceInvoicePosDelete]]
    discount_save: Optional[List[SaveInvoiceDiscountSave]]
    discount_delete: Optional[List[SaveInvoiceDiscountDelete]]
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        invoice = SaveInvoiceInvoiceObject.from_dict(d.pop("invoice"))

        invoice_pos_save = []
        _invoice_pos_save = d.pop("invoicePosSave")
        for invoice_pos_save_item_data in _invoice_pos_save or []:
            invoice_pos_save_item = SaveInvoiceInvoicePosObject.from_dict(
        ...
        for invoice_pos_delete_item_data in _invoice_pos_delete or []:
            invoice_pos_delete_item = SaveInvoiceInvoicePosDelete.from_dict(
        ...
        for discount_save_item_data in _discount_save or []:
            discount_save_item = SaveInvoiceDiscountSave.from_dict(
                discount_save_item_data
            )
        ...
        for discount_delete_item_data in _discount_delete or []:
            discount_delete_item = SaveInvoiceDiscountDelete.from_dict(
