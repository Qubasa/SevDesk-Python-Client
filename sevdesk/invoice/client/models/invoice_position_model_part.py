...
T = TypeVar("T", bound="InvoicePositionModelPart")


@attr.s(auto_attribs=True)
class InvoicePositionModelPart:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        invoice_position_model_part = cls(
            id=id,
            object_name=object_name,
        )

        invoice_position_model_part.additional_properties = d
        return invoice_position_model_part
