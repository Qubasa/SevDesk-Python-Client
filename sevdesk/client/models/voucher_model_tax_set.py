...
T = TypeVar("T", bound="VoucherModelTaxSet")


@attr.s(auto_attribs=True)
class VoucherModelTaxSet:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        voucher_model_tax_set = cls(
            id=id,
            object_name=object_name,
        )

        voucher_model_tax_set.additional_properties = d
        return voucher_model_tax_set
