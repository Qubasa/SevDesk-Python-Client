...
T = TypeVar("T", bound="GetCheckAccountsResponse200")


@attr.s(auto_attribs=True)
class GetCheckAccountsResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_check_accounts_response_200 = cls(
            objects=objects,
        )

        get_check_accounts_response_200.additional_properties = d
        return get_check_accounts_response_200
