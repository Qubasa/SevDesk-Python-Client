...
T = TypeVar("T", bound="CreditNotePosition")


@attr.s(auto_attribs=True)
class CreditNotePosition:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        credit_note_position.additional_properties = d
        return credit_note_position
