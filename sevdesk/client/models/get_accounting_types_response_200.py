...
class GetAccountingTypesResponse200:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for objects_item_data in _objects or []:
            objects_item = GetAccountingTypesResponse200ObjectsItem.from_dict(
                objects_item_data
            )

            objects.append(objects_item)

        get_accounting_types_response_200 = cls(
            objects=objects,
        )

        get_accounting_types_response_200.additional_properties = d
        return get_accounting_types_response_200
