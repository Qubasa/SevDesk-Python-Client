...
T = TypeVar("T", bound="GetCreditNoteByIdResponse200")


@attr.s(auto_attribs=True)
class GetCreditNoteByIdResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_credit_note_by_id_response_200 = cls(
            objects=objects,
        )

        get_credit_note_by_id_response_200.additional_properties = d
        return get_credit_note_by_id_response_200
