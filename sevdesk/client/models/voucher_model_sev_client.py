...
T = TypeVar("T", bound="VoucherModelSevClient")


@attr.s(auto_attribs=True)
class VoucherModelSevClient:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        voucher_model_sev_client = cls(
            id=id,
            object_name=object_name,
        )

        voucher_model_sev_client.additional_properties = d
        return voucher_model_sev_client
