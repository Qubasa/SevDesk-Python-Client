...
T = TypeVar("T", bound="VoucherModelSupplier")


@attr.s(auto_attribs=True)
class VoucherModelSupplier:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        voucher_model_supplier = cls(
            id=id,
            object_name=object_name,
        )

        voucher_model_supplier.additional_properties = d
        return voucher_model_supplier
