...
T = TypeVar("T", bound="FactoryInvoicePositionSave")


@attr.s(auto_attribs=True)
class FactoryInvoicePositionSave:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        factory_invoice_position_save = cls(
            unity=unity,
            tax_rate=tax_rate,
            map_all=map_all,
            id=id,
        ...
        factory_invoice_position_save.additional_properties = d
        return factory_invoice_position_save
