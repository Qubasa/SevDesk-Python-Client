...
class GetInvoiceDiscountsByIdResponse200:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_invoice_discounts_by_id_response_200 = cls(
            objects=objects,
        )

        get_invoice_discounts_by_id_response_200.additional_properties = d
        return get_invoice_discounts_by_id_response_200
