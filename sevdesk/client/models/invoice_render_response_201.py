...
class InvoiceRenderResponse201:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for objects_item_data in _objects or []:
            objects_item = InvoiceRenderResponse201ObjectsItem.from_dict(
                objects_item_data
            )

            objects.append(objects_item)

        invoice_render_response_201 = cls(
            objects=objects,
        )

        invoice_render_response_201.additional_properties = d
        return invoice_render_response_201
