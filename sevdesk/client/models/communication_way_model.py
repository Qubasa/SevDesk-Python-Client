...
class CommunicationWayModel:
    ...
    Attributes:
        ...
        value (str): The value of the communication way. For example the phone number, e-mail address or website.
        key (CommunicationWayModelKey): The key of the communication way. Similar to the category of addresses. For all
