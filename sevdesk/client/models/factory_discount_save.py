...
T = TypeVar("T", bound="FactoryDiscountSave")


@attr.s(auto_attribs=True)
class FactoryDiscountSave:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        factory_discount_save.additional_properties = d
        return factory_discount_save
