...
if TYPE_CHECKING:
    from ..models.credit_note_position_credit_note import CreditNotePositionCreditNote
...
T = TypeVar("T", bound="FactoryCreditNotePositionSave")


@attr.s(auto_attribs=True)
class FactoryCreditNotePositionSave:
    """
    Attributes:
        ...
        object_name (Union[Unset, str]): The invoice position object name Default: 'CreditNotePos'.
        credit_note (Union[Unset, CreditNotePositionCreditNote]): The invoice to which the position belongs.
    """
    ...
    object_name: Union[Unset, str] = "CreditNotePos"
    credit_note: Union[Unset, "CreditNotePositionCreditNote"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        from ..models.credit_note_position_credit_note import (
        ...
        credit_note: Union[Unset, CreditNotePositionCreditNote]
        if isinstance(_credit_note, Unset):
            credit_note = UNSET
        else:
            credit_note = CreditNotePositionCreditNote.from_dict(_credit_note)

        factory_credit_note_position_save = cls(
            unity=unity,
            tax_rate=tax_rate,
            map_all=map_all,
            id=id,
        ...
        factory_credit_note_position_save.additional_properties = d
        return factory_credit_note_position_save
