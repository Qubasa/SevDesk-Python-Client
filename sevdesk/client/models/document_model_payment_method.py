...
T = TypeVar("T", bound="DocumentModelPaymentMethod")


@attr.s(auto_attribs=True)
class DocumentModelPaymentMethod:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        document_model_payment_method = cls(
            id=id,
            object_name=object_name,
        )

        document_model_payment_method.additional_properties = d
        return document_model_payment_method
