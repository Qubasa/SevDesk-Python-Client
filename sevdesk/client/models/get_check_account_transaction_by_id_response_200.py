...
T = TypeVar("T", bound="GetCheckAccountTransactionByIdResponse200")


@attr.s(auto_attribs=True)
class GetCheckAccountTransactionByIdResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_check_account_transaction_by_id_response_200 = cls(
            objects=objects,
        )

        get_check_account_transaction_by_id_response_200.additional_properties = d
        return get_check_account_transaction_by_id_response_200
