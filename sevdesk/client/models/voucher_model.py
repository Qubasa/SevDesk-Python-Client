...
from ..models.voucher_model_credit_debit import VoucherModelCreditDebit
from ..models.voucher_model_recurring_interval import VoucherModelRecurringInterval
from ..models.voucher_model_status import VoucherModelStatus
from ..models.voucher_model_voucher_type import VoucherModelVoucherType
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.voucher_model_cost_centre import VoucherModelCostCentre
    from ..models.voucher_model_create_user import VoucherModelCreateUser
    from ..models.voucher_model_document import VoucherModelDocument
    from ..models.voucher_model_sev_client import VoucherModelSevClient
    from ..models.voucher_model_supplier import VoucherModelSupplier
    from ..models.voucher_model_tax_set import VoucherModelTaxSet


T = TypeVar("T", bound="VoucherModel")
...
class VoucherModel:
    ...
    Attributes:
        ...
        status (VoucherModelStatus): Please have a look in
        ...
        credit_debit (VoucherModelCreditDebit): Defines if your voucher is a credit (C) or debit (D) Example: C.
        voucher_type (VoucherModelVoucherType): Type of the voucher. For more information on the different types, check
        ...
        sev_client (Union[Unset, VoucherModelSevClient]): Client to which voucher belongs. Will be filled automatically
        create_user (Union[Unset, VoucherModelCreateUser]): User who created the voucher. Will be filled automatically.
        voucher_date (Union[Unset, None, datetime.datetime]): Needs to be provided as timestamp or dd.mm.yyyy Example:
            01.01.2022.
        supplier (Union[Unset, None, VoucherModelSupplier]): The contact used in the voucher as a supplier.<br>
        ...
        recurring_interval (Union[Unset, None, VoucherModelRecurringInterval]): The DateInterval in which recurring
            vouchers are generated.<br>
        ...
        tax_set (Union[Unset, None, VoucherModelTaxSet]): Tax set of the voucher. Needs to be added if you chose the tax
            type custom
        ...
        delivery_date_until (Union[Unset, None, datetime.datetime]): Needs to be provided as timestamp or dd.mm.yyyy
            Example: 22.02.2022.
        document (Union[Unset, None, VoucherModelDocument]): The document of the voucher.
        cost_centre (Union[Unset, VoucherModelCostCentre]): Cost centre for the voucher
    """
    ...
    tax_type: str
    credit_debit: VoucherModelCreditDebit
    voucher_type: VoucherModelVoucherType
    id: Union[Unset, int] = UNSET
    create: Union[Unset, datetime.datetime] = UNSET
    update: Union[Unset, datetime.datetime] = UNSET
    sev_client: Union[Unset, "VoucherModelSevClient"] = UNSET
    create_user: Union[Unset, "VoucherModelCreateUser"] = UNSET
    voucher_date: Union[Unset, None, datetime.datetime] = UNSET
    supplier: Union[Unset, None, "VoucherModelSupplier"] = UNSET
    ...
    recurring_interval: Union[Unset, None, VoucherModelRecurringInterval] = UNSET
    ...
    tax_set: Union[Unset, None, "VoucherModelTaxSet"] = UNSET
    ...
    document: Union[Unset, None, "VoucherModelDocument"] = UNSET
    cost_centre: Union[Unset, "VoucherModelCostCentre"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        status = VoucherModelStatus(d.pop("status"))

        tax_type = d.pop("taxType")

        credit_debit = VoucherModelCreditDebit(d.pop("creditDebit"))

        voucher_type = VoucherModelVoucherType(d.pop("voucherType"))
        ...
        sev_client: Union[Unset, VoucherModelSevClient]
        if isinstance(_sev_client, Unset):
            sev_client = UNSET
        else:
            sev_client = VoucherModelSevClient.from_dict(_sev_client)

        _create_user = d.pop("createUser", UNSET)
        create_user: Union[Unset, VoucherModelCreateUser]
        if isinstance(_create_user, Unset):
            create_user = UNSET
        else:
            create_user = VoucherModelCreateUser.from_dict(_create_user)
        ...
        supplier: Union[Unset, None, VoucherModelSupplier]
        if _supplier is None:
            supplier = None
        elif isinstance(_supplier, Unset):
            supplier = UNSET
        else:
            supplier = VoucherModelSupplier.from_dict(_supplier)
        ...
        recurring_interval: Union[Unset, None, VoucherModelRecurringInterval]
        if _recurring_interval is None:
            recurring_interval = None
        elif isinstance(_recurring_interval, Unset):
            recurring_interval = UNSET
        else:
            recurring_interval = VoucherModelRecurringInterval(_recurring_interval)
        ...
        tax_set: Union[Unset, None, VoucherModelTaxSet]
        if _tax_set is None:
            tax_set = None
        elif isinstance(_tax_set, Unset):
            tax_set = UNSET
        else:
            tax_set = VoucherModelTaxSet.from_dict(_tax_set)
        ...
        document: Union[Unset, None, VoucherModelDocument]
        if _document is None:
            document = None
        elif isinstance(_document, Unset):
            document = UNSET
        else:
            document = VoucherModelDocument.from_dict(_document)

        _cost_centre = d.pop("costCentre", UNSET)
        cost_centre: Union[Unset, VoucherModelCostCentre]
        if isinstance(_cost_centre, Unset):
            cost_centre = UNSET
        else:
            cost_centre = VoucherModelCostCentre.from_dict(_cost_centre)
        ...
        voucher_model.additional_properties = d
