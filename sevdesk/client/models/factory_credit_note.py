...
T = TypeVar("T", bound="FactoryCreditNote")


@attr.s(auto_attribs=True)
class FactoryCreditNote:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        factory_credit_note.additional_properties = d
        return factory_credit_note
