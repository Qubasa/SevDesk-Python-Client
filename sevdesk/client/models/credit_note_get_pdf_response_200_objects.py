...
T = TypeVar("T", bound="CreditNoteGetPdfResponse200Objects")


@attr.s(auto_attribs=True)
class CreditNoteGetPdfResponse200Objects:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        credit_note_get_pdf_response_200_objects = cls(
            filename=filename,
            mimetype=mimetype,
            content=content,
        ...
        credit_note_get_pdf_response_200_objects.additional_properties = d
        return credit_note_get_pdf_response_200_objects
