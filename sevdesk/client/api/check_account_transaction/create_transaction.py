...
from ...models.check_account_transaction_model import CheckAccountTransactionModel
...
def _get_kwargs(
    *,
    client: Client,
    json_body: CheckAccountTransactionModel,
) -> Dict[str, Any]:
...
def _parse_response(
    *, client: Client, response: httpx.Response
    ...
    if response.status_code == HTTPStatus.CREATED:
        response_201 = CheckAccountTransactionResponseModel.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Args:
        json_body (CheckAccountTransactionModel): CheckAccountTransaction model. Responsible for
            the transactions on payment accounts.
