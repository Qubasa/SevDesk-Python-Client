...
from ...models.get_check_account_transaction_by_id_response_200 import (
...
) -> Optional[Union[Any, GetCheckAccountTransactionByIdResponse200]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetCheckAccountTransactionByIdResponse200.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Client, response: httpx.Response
) -> Response[Union[Any, GetCheckAccountTransactionByIdResponse200]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, GetCheckAccountTransactionByIdResponse200]
    """
