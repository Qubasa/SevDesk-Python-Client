...
def sync_detailed(
    *,
    ...
    """Retrieve invoices
     ...
     There are a multitude of parameter which can be used to filter. A few of them are attached but for a
    complete list please check out docs.
...
def sync(
    *,
    ...
    Returns:
        Union[Any, GetInvoicesResponse200]
    """
