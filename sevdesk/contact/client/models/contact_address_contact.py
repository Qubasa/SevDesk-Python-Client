...
T = TypeVar("T", bound="ContactAddressContact")


@attr.s(auto_attribs=True)
class ContactAddressContact:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        contact_address_contact = cls(
            id=id,
            object_name=object_name,
        )

        contact_address_contact.additional_properties = d
        return contact_address_contact
