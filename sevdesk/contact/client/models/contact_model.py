...
class ContactModel:
    ...
    Attributes:
        category (ContactModelCategory): Category of the contact.<br> For more information,
        ...
        parent (Union[Unset, None, ContactModelParent]): The parent contact to which this contact belongs. Must be an
            organization.
        surename (Union[Unset, None, str]): The <b>first</b> name of the contact.<br>
            Yeah... not quite right in literally every way. We know.<br>
            Not to be used for organizations. Example: John.
        familyname (Union[Unset, None, str]): The last name of the contact.<br>
            Not to be used for organizations. Example: Snow.
        titel (Union[Unset, None, str]): A non-academic title for the contact.
        ...
        description (Union[Unset, None, str]): A description for the contact. Example: Rightful king of the seven
            kingdoms.
        academic_title (Union[Unset, None, str]): A academic title for the contact.
            Not to be used for organizations.
        gender (Union[Unset, None, str]): Gender of the contact.<br>
            Not to be used for organizations.
        sev_client (Union[Unset, ContactModelSevClient]): Client to which contact belongs. Will be filled automatically
        name2 (Union[Unset, None, str]): Second name of the contact.<br>
            Not to be used for organizations. Example: Targaryen.
        birthday (Union[Unset, None, datetime.date]): Birthday of the contact.<br>
            Not to be used for organizations.
        ...
        default_discount_amount (Union[Unset, None, float]): The default discount the contact gets for every
            invoice.<br>
